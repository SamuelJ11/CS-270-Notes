...
### Understanding Pointers
    ...
    • Arrays and pointers are closely related:
        ...
        - array referencing has the exact same effect as pointer arithmetic and dereferencing
            ...
            * so if A[] is of type int, the second expression takes the base address of A (A[0]) and adds 3 * 4 (i = 4 bytes for an int) to it to get the address of the fourth element
...
### Life in the Real World: Using the GBD Debugger
